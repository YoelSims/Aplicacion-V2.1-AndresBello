...
class Ui_ventanaPrincipal(object):
    def setupUi(self, ventanaPrincipal):
        ...
        self.subMenuContenedorIzquierdo.setMinimumSize(QSize(0, 0))
        ...
        self.horizontalLayout_34.setContentsMargins(25, 0, 0, 0)
        self.frame_34 = QFrame(self.widget_10)
        self.frame_34.setObjectName(u"frame_34")
        self.frame_34.setFrameShape(QFrame.StyledPanel)
        self.frame_34.setFrameShadow(QFrame.Raised)
        self.pushButton_5 = QPushButton(self.frame_34)
        self.pushButton_5.setObjectName(u"pushButton_5")
        self.pushButton_5.setGeometry(QRect(75, 16, 25, 33))
        icon2 = QIcon()
        icon2.addFile(u":/feather/icons/feather/arrow-down.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButton_5.setIcon(icon2)
        self.pushButton_4 = QPushButton(self.frame_34)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(0, 9, 75, 47))
        icon3 = QIcon()
        icon3.addFile(u":/material_design/icons/material_design/add_home.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.horizontalLayout_32 = QHBoxLayout(self.frame_33)
        ...
        self.inicioBoton.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/font_awesome_solid/icons/font_awesome/solid/user-large.png", QSize(), QIcon.Normal, QIcon.Off)
        self.estudianteBoton.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/feather/icons/feather/layers.png", QSize(), QIcon.Normal, QIcon.Off)
        self.materiaBoton.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/font_awesome_solid/icons/font_awesome/solid/user-group.png", QSize(), QIcon.Normal, QIcon.Off)
        self.profesorBoton.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/feather/icons/feather/clipboard.png", QSize(), QIcon.Normal, QIcon.Off)
        self.notaBoton.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/font_awesome_solid/icons/font_awesome/solid/print.png", QSize(), QIcon.Normal, QIcon.Off)
        self.documentoBoton.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/font_awesome_solid/icons/font_awesome/solid/graduation-cap.png", QSize(), QIcon.Normal, QIcon.Off)
        self.gradosBoton.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/feather/icons/feather/settings.png", QSize(), QIcon.Normal, QIcon.Off)
        self.ajustesBoton.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/feather/icons/feather/alert-circle.png", QSize(), QIcon.Normal, QIcon.Off)
        self.acercaDeBoton.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/material_design/icons/material_design/help_outline.png", QSize(), QIcon.Normal, QIcon.Off)
        self.ayudaBoton.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/font_awesome_solid/icons/font_awesome/solid/lock.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cerrarSesionBoton.setIcon(icon14)
        ...
        self.acercaDePagina.setLayoutDirection(Qt.LeftToRight)
        self.verticalLayout_10 = QVBoxLayout(self.acercaDePagina)
        self.verticalLayout_10.setObjectName(u"verticalLayout_10")
        self.frame_5 = QFrame(self.acercaDePagina)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/font_awesome_regular/icons/font_awesome/regular/circle-xmark.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cerrarMenuCentro.setIcon(icon15)
        ...
        self.frame_31 = QFrame(self.acercaDePagina)
        ...
        self.toolBox = QToolBox(self.frame_31)
        self.toolBox.setObjectName(u"toolBox")
        self.toolBox.setLayoutDirection(Qt.LeftToRight)
        self.page = QWidget()
        self.page.setObjectName(u"page")
        self.page.setGeometry(QRect(0, 0, 209, 584))
        ...
        icon16 = QIcon()
        icon16.addFile(u":/feather/icons/feather/arrow-up-circle.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.verticalLayout_38.addWidget(self.pushButton_2)

        self.pushButton_3 = QPushButton(self.frame_32)
        self.pushButton_3.setObjectName(u"pushButton_3")

        self.verticalLayout_38.addWidget(self.pushButton_3)


        self.verticalLayout_35.addWidget(self.frame_32)

        self.toolBox.addItem(self.page, icon4, u"")
        self.page_2 = QWidget()
        self.page_2.setObjectName(u"page_2")
        self.page_2.setGeometry(QRect(0, 0, 77, 603))
        self.toolBox.addItem(self.page_2, u"Page 2")

        self.verticalLayout_32.addWidget(self.toolBox, 0, Qt.AlignLeft)


        self.verticalLayout_10.addWidget(self.frame_31, 0, Qt.AlignLeft)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/font_awesome_regular/icons/font_awesome/regular/bell.png", QSize(), QIcon.Normal, QIcon.Off)
        self.notificacionBoton.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/feather/icons/feather/more-horizontal.png", QSize(), QIcon.Normal, QIcon.Off)
        self.masBoton.setIcon(icon18)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/font_awesome_regular/icons/font_awesome/regular/circle-user.png", QSize(), QIcon.Normal, QIcon.Off)
        self.perfilBoton.setIcon(icon19)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/feather/icons/feather/search.png", QSize(), QIcon.Normal, QIcon.Off)
        self.busquedaBoton.setIcon(icon20)
        ...
        icon21 = QIcon()
        icon21.addFile(u":/font_awesome_regular/icons/font_awesome/regular/trash-can.png", QSize(), QIcon.Normal, QIcon.Off)
        self.botonMenuEliminar.setIcon(icon21)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/font_awesome_solid/icons/font_awesome/solid/minus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.minimizarBoton.setIcon(icon22)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/font_awesome_regular/icons/font_awesome/regular/square.png", QSize(), QIcon.Normal, QIcon.Off)
        self.restaurarBoton.setIcon(icon23)
        ...
        icon24 = QIcon()
        icon24.addFile(u":/font_awesome_solid/icons/font_awesome/solid/xmark.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cerrarBoton.setIcon(icon24)
        ...
        icon25 = QIcon()
        icon25.addFile(u":/font_awesome_solid/icons/font_awesome/solid/arrow-right.png", QSize(), QIcon.Normal, QIcon.Off)
        self.masVer.setIcon(icon25)
        ...
        icon26 = QIcon()
        icon26.addFile(u":/feather/icons/feather/arrow-right.png", QSize(), QIcon.Normal, QIcon.Off)
        self.verMas2.setIcon(icon26)
        ...
        self.cerrarMenuDerecho.setIcon(icon15)
        ...
        icon27 = QIcon()
        icon27.addFile(u":/feather/icons/feather/check-circle.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actualizarBoton.setIcon(icon27)
        ...
        icon28 = QIcon()
        icon28.addFile(u":/feather/icons/feather/alert-triangle.png", QSize(), QIcon.Normal, QIcon.Off)
        self.eliminarBoton.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/feather/icons/feather/refresh-cw.png", QSize(), QIcon.Normal, QIcon.Off)
        self.editarBoton.setIcon(icon29)
        ...
        self.cerrarNotificacion.setIcon(icon15)
    ...
    def retranslateUi(self, ventanaPrincipal):
        ...
        self.pushButton_4.setText(QCoreApplication.translate("ventanaPrincipal", u"INICIO", None))
#if QT_CONFIG(tooltip)
        ...
        self.pushButton.setText(QCoreApplication.translate("ventanaPrincipal", u"Estudiantes Informacion", None))
        self.pushButton_2.setText(QCoreApplication.translate("ventanaPrincipal", u"PushButton", None))
        self.pushButton_3.setText(QCoreApplication.translate("ventanaPrincipal", u"PushButton", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), "")
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), QCoreApplication.translate("ventanaPrincipal", u"Page 2", None))
