...
class Ui_ventanaPrincipal(object):
    def setupUi(self, ventanaPrincipal):
        ...
        ventanaPrincipal.resize(1161, 829)
        ...
        icon = QIcon()
        icon.addFile(u":/font_awesome_solid/icons/font_awesome/solid/align-justify.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/font_awesome_solid/icons/font_awesome/solid/user-large.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/feather/icons/feather/layers.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/font_awesome_solid/icons/font_awesome/solid/user-group.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/feather/icons/feather/clipboard.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/font_awesome_solid/icons/font_awesome/solid/print.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/font_awesome_solid/icons/font_awesome/solid/graduation-cap.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/feather/icons/feather/alert-circle.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/material_design/icons/material_design/help_outline.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/font_awesome_solid/icons/font_awesome/solid/lock.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/font_awesome_regular/icons/font_awesome/regular/circle-xmark.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.busquedaBoton.setIcon(icon16)
        ...
        self.horizontalLayout_4.addWidget(self.frame_15, 0, Qt.AlignVCenter)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/font_awesome_regular/icons/font_awesome/regular/trash-can.png", QSize(), QIcon.Normal, QIcon.Off)
        self.botonMenuEliminar.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/font_awesome_solid/icons/font_awesome/solid/minus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.minimizarBoton.setIcon(icon18)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/font_awesome_regular/icons/font_awesome/regular/square.png", QSize(), QIcon.Normal, QIcon.Off)
        self.restaurarBoton.setIcon(icon19)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/font_awesome_solid/icons/font_awesome/solid/xmark.png", QSize(), QIcon.Normal, QIcon.Off)
        self.cerrarBoton.setIcon(icon20)
